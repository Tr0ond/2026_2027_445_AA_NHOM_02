<template>
  <div>
    <div class="mb-5 flex items-end justify-between gap-4 flex-wrap">
      ...
      <button class="nut-chinh text-sm disabled:opacity-50 disabled:cursor-not-allowed" :disabled="!lopChuaPhanCong.length" @click="moModalPhanCong()"><i class="fa-solid fa-plus"></i>Phân công mới</button>
    </div>
